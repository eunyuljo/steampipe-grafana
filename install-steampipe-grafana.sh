...
# =============================================================================
# Steampipe + Grafana v12.3.3 자동 설치 스크립트 (로컬 설치)
# 지원 OS: Amazon Linux 2023, Ubuntu 20.04+, CentOS/RHEL 8+
# 요구사항: Python 3.10+ (pyenv 권장)
# 고정 버전: Grafana v12.3.3 (대시보드 호환성 보장)
# =============================================================================
...
EOF
            ...
            log_info "Grafana v12.3.3 최신 버전 설치 중..."
    ...
    if [[ "$installed_version" =~ ^12\. ]]; then
        log_success "Grafana v12.x 최신 버전 설치 완료 ✅"
        log_info "✨ 최신 기능과 개선된 성능을 제공하는 버전입니다."
        log_info "🎨 향상된 시각화 옵션과 사용자 경험을 제공합니다."
    else
        log_warning "예상 버전(12.x)과 다른 버전이 설치됨: $installed_version"
        log_info "최신 기능을 사용할 수 없을 수 있습니다."
    fi
}
